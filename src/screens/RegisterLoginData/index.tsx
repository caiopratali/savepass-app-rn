...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const list = await AsyncStorage.getItem(dataKey).then(res => JSON.parse(res));

    const addNewItemInList = [...list, newLoginData];

    await AsyncStorage.setItem(dataKey, JSON.stringify(addNewItemInList));
